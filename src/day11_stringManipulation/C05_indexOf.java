...
public class C05_indexOf {
    public static void main(String[] args) {
        ...
        // (inclusive) denir buna, ve ilk buldugu b nin indexini bize dondurur
        ...
        // soru : Kullanicidan mail adresini isteyin @ isareti icermiyorsa gecersiz yazdirin
      ...
      // int result = mail.indexOf("@");
      // System.out.println(result == -1 ? "gecersiz" : "mailiniz kabul edildi" );
