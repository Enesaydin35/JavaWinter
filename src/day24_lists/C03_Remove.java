...
public class C03_Remove {
    public static void main(String[] args) {
        ...
        sayi degeri girdiginizde java otomatik olarak  sayiyi index kabul eder
         */

        // int sayi =5;
        // sayilar.remove(sayi); // IndexOutOfBoundsException

        Integer sayi =5; // Integer wrapper class'ı kullanınca sayi obje oldugundan bu method calisti
        sayilar.remove(sayi);
